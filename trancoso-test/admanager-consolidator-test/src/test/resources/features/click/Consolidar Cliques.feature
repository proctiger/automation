#language:pt
#author:dvrocha
Funcionalidade: Consolidar Cliques
  ...
  Cenario: Não existem nenhum registro para o anúncio a ser processado
    ...
    Então o sistema contabiliza os cliques do arquivo
 ...
 Cenario: Já existe um registro para anúncio para um dia diferente
   Dado que existe algum arquivo de cliques a ser processado
   E que já existe um registro no banco para o anúncio a ser processado com cliques para um dia diferente
   Quando for iniciado o processamento de cliques
   Então o sistema contabiliza os cliques do arquivo
 
 Cenario: Já existe um registro para o anúncio para um slot diferente
   Dado que existe algum arquivo de cliques a ser processado
   E que já existe um registro no banco para o anúncio a ser processado com cliques para um slot diferente
   Quando for iniciado o processamento de cliques
   Então o sistema contabiliza os cliques do arquivo
 
 Cenario: Já existe um registro para o anúncio com venda diferente
   Dado que existe algum arquivo de cliques a ser processado
   E que já existe um registro no banco para o anúncio a ser processado com cliques para uma venda diferente
   Quando for iniciado o processamento de cliques
   Então o sistema contabiliza os cliques do arquivo
 
 Cenario: Já existe um registro para o anúncio com hora diferente
   Dado que existe algum arquivo de cliques a ser processado
   E que já existe um registro no banco para o anúncio a ser processado com cliques para uma hora diferente
   Quando for iniciado o processamento de cliques
   Então o sistema contabiliza os cliques do arquivo
