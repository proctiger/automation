...
import uol.adserversap.manager.test.feature.AdicionarLoginTestNegative;
import uol.adserversap.manager.test.feature.AdicionarLoginTestPositive;
 ...
 */
@RunWith(Suite.class)
@SuiteClasses({ AdicionarLoginTestPositive.class, AdicionarLoginTestNegative.class })
public class TestSuiteUserAdd extends BasicWebTest {
	@BeforeClass
